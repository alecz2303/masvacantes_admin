...
return [
    ...
    'empresa_link_text' => 'Ver todas las empresas',
    'post_text'      => 'Tiene :count :string en su base de datos. Haga clic en el botón de abajo para ver todos los posts.',
    'empresa_text'   => 'Tiene :count :string en su base de datos. Haga clic en el botón de abajo para ver todas las empresas.',
